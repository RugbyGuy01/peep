package com.golfpvcc.peep.infra.push_notification

import com.golfpvcc.peep.domain.model.DeviceToken
import com.golfpvcc.peep.domain.model.PushNotification
import com.golfpvcc.peep.domain.model.PushNotificationSendResult
                        ...
                        DeviceToken.Platform.ANDROID -> {
                            setAndroidConfig(
                                AndroidConfig.builder()
                                    ...
                                    .setRestrictedPackageName("com.golfpvcc.peep")
                                    .build()
                            )
                        }
