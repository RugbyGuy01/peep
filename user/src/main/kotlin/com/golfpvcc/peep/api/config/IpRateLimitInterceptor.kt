package com.golfpvcc.peep.api.config

import com.golfpvcc.peep.domain.exception.RateLimitException
import com.golfpvcc.peep.infra.rate_limiting.IpRateLimiter
import com.golfpvcc.peep.infra.rate_limiting.IpResolver
...
class IpRateLimitInterceptor(
    ...
    @param:Value("\${peep.rate-limit.ip.apply-limit}")
